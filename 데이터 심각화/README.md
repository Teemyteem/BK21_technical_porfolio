...
- EDA (Exploratory Data Analysis)	
  ...
  - Histogram:
  	- shows the frequency of each features			
  ...
  - Box plot:
  	- shows min, Q1, median, Q3, max, and outlier of numerical variables	
  ...
  - kde plot:
  	- show the distribution of variable using a smooth curve	
        -(column: age, avg_glucose_level, bmi)		
  ...
  - Bar plot:
  	- show the frequency or count of each category in the categorical variable		
